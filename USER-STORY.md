...
- [x] Technischer Durchstich: API-Test in Keypirinha
- [x] Entscheidung: Email-Handling (Option C: Hinweis in short_desc + Action)
- [x] Plugin finalisieren (State Machine, Filter Mode, #edit Shortcut)
